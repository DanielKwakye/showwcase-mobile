...
class ThreadPreviewBrowserPage extends StatefulWidget {
  ...
  const ThreadPreviewBrowserPage({Key? key, required this.url, required this.thread}) : super(key: key);
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              Text(widget.thread.user?.displayName ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: theme.textTheme.bodyMedium,)

            ],
          ),
          actions: [
            IconButton(onPressed: () {
              copyTextToClipBoard(context, widget.url, toastMessage: "Link copied");
          ...
          builder: (context, reactiveThread) {
            return SafeArea(
              ...
              child: Padding(
                ...
                child: ThreadFeedActionBarWidget(thread: reactiveThread, hideActions: true,),
              ),
            );
          },
        ),
...
class ThreadBrowserPageController extends State<ThreadPreviewBrowserPage> {
  ...
  late ThreadPreviewBrowserCubit threadPreviewCubit;
  ...
  void initState() {
    ...
    threadPreviewCubit = context.read<ThreadPreviewBrowserCubit>();
