...
class LatestFeedsThreadCubit extends ThreadCubit {

  LatestFeedsThreadCubit(super.threadRepository, {required super.threadBroadcastRepository});
  ...
  Future<Either<String, List<ThreadModel>>> fetchThreadFeeds(int pageKey) {
    ...
    final path = ApiConfig.fetchLatestThreadFeeds(skip: skip, limit: defaultPageSize);
