...
class NewsFeedsThreadCubit extends ThreadCubit {

  NewsFeedsThreadCubit(super.threadRepository, {required super.threadBroadcastRepository});
  ...
  Future<Either<String, List<ThreadModel>>> fetchThreadFeeds(int pageKey) {
    ...
    final path = ApiConfig.fetchNewsThreadFeeds(skip: skip, limit: defaultPageSize);
