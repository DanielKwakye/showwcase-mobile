...
class ChatAppBarWidget extends StatelessWidget {
  ...
  const ChatAppBarWidget({Key? key, this.pinned = true, this.floating = false, required this.onProfileTapped}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SliverAppBar(
      ...
      //   ),
      // ): null,
      title: Text("Chat", style: TextStyle(color: theme.colorScheme.onBackground, fontWeight: FontWeight.w700,fontSize: defaultFontSize),),
      actions: [
