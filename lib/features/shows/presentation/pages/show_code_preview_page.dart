...
class ShowCodePreviewPage extends StatefulWidget {

  final String code;
  final String? codeLanguage;
  final String tag;
  final ShowModel showModel;
  const ShowCodePreviewPage({Key? key,
  ...
  @override
  ShowCodePreviewPageController createState() => ShowCodePreviewPageController();
}
...
class _ShowCodePreviewPageView extends WidgetView<ShowCodePreviewPage, ShowCodePreviewPageController> {

  const _ShowCodePreviewPageView(ShowCodePreviewPageController state) : super(state);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: DecoratedBox(
        ...
        child: BlocSelector<ShowPreviewCodeCubit, ShowPreviewState, ShowModel>(
          selector: (state){
              ...
              child: Column(
                ...
                children: [
                  ...
                  if(widget.showModel.title != null) ... {
                    Text(widget.showModel.title!, style: theme.textTheme.titleMedium?.copyWith(fontSize: defaultFontSize, fontWeight: FontWeight.w700, color: kAppWhite),),
...
class ShowCodePreviewPageController extends State<ShowCodePreviewPage> {

  late ShowPreviewCodeCubit showPreviewCodeCubit;
  late Brightness originalThemeBrightness;

  @override
  Widget build(BuildContext context) => _ShowCodePreviewPageView(this);

  @override
  void initState() {
    super.initState();
    showPreviewCodeCubit = context.read<ShowPreviewCodeCubit>();
    showPreviewCodeCubit.setShowPreview(show: widget.showModel);
