...
class NotificationNewThreadVoteWidget extends StatelessWidget {
  final NotificationModel notificationResponse;

  const NotificationNewThreadVoteWidget(
                ...
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    ...users.map((user) {
                     ...
                     TextSpan(
                        text: ' upvoted your', style: TextStyle(color: theme(context).colorScheme.onPrimary,fontWeight: FontWeight.w500)),
                    const TextSpan(
                        text: ' Thread',
