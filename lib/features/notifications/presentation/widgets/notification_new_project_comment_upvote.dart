...
class NotificationNewProjectCommentUpvote extends StatelessWidget {
  final NotificationModel notificationResponse;

  const NotificationNewProjectCommentUpvote(
    ...
    return GestureDetector(
      ...
      onTap: () {
        context.push(context.generateRoutePath(
            subLocation: showCommentsPage,),extra: notificationResponse.data?.project);
      },
      child: Row(
              ...
              children: <Widget>[
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      const TextSpan(
                          text: ' commented on your show', style: TextStyle()),
                    ],
                  ),
                ),
                const SizedBox(
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ShowsUserMetaDataWidget(
                        user: notificationResponse.data!.comment!.user!,
                        show: notificationResponse.data!.project!,
                        showMoreMenu: false,
                        showUsername: true,
                        withTime: notificationResponse.data!.comment!.createdAt,
                      ),
                      ShowCommentMessageWidget(
                        showModel: notificationResponse.data!.project!,
                        message:
                            notificationResponse.data!.comment!.message ?? '',
                      ),
                    ],
                  ),
                ),
                ...
                GestureDetector(
                  ...
                  onTap: () {
                    context.push(context.generateRoutePath(
                        subLocation: showPreviewPage,),extra: notificationResponse.data?.project);
                  },
                  child: Container(
                    padding:
                        const EdgeInsets.symmetric(vertical: 10, horizontal: 10),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (notificationResponse.data!.project!.publishedDate !=
                            null)
                          Text(
                            getFormattedDateWithIntl(
                                notificationResponse.data!.project!.publishedDate!,
                                format: 'd MMMM'),
                            style: TextStyle(
                                fontWeight: FontWeight.w700,
                                fontSize: 13,
