...
class NotificationNewCommunityMemberWidget extends StatelessWidget {

  final NotificationModel notificationResponse;
  const NotificationNewCommunityMemberWidget({
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      const TextSpan(text: ' just joined your community ', style: TextStyle()),
