...
class NotificationNewGuestbook extends StatelessWidget {
  final NotificationModel notificationResponse;
  const NotificationNewGuestbook({super.key, required this.notificationResponse});
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      const TextSpan(text: ' wrote in your guestbook ', style: TextStyle()),
