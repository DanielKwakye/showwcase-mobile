...
class NotificationNewCommunityInviteWidget extends StatelessWidget {

  final NotificationModel notificationResponse;
  const NotificationNewCommunityInviteWidget({
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    const TextSpan(text: ' sent you an invitation to join ', style: TextStyle()),
                    TextSpan(text: notificationResponse.data?.community?.name ?? '', style: const TextStyle(fontWeight: FontWeight.w600)),
                    const TextSpan(text: ' Community', style: TextStyle()),
