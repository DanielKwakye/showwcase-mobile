...
class NotificationEditGuestbook extends StatelessWidget {
  final NotificationModel notificationResponse;
  const NotificationEditGuestbook({super.key, required this.notificationResponse});
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      const TextSpan(text: ' edited your guestbook ', style: TextStyle()),
