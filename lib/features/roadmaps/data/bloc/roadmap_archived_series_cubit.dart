...
class RoadmapArchivedSeriesCubit extends SeriesCubit {

  RoadmapArchivedSeriesCubit({required super.seriesRepository, required super.showsBroadcastRepository});

  Future<Either<String, List<SeriesModel>>> fetchArchivedRoadmapSeriesCubit(
    ...
    final path =  ApiConfig.fetchRoadmapSeriesInArchive(roadmapId: roadmapId, limit: defaultPageSize, skip: skip);
