...
class SearchShowsCubit extends ShowsCubit {

  SearchShowsCubit({required super.showsRepository, required super.showsBroadcastRepository});

  Future<Either<String, List<ShowModel>>> fetchSearchedShows(
    ...
    final path =  ApiConfig.search(limit: defaultPageSize, skip: skip, type: 'projects', text: searchWord);
