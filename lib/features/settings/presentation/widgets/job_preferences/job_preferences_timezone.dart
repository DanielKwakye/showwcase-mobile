...
class JobPreferencesTimeZone extends StatefulWidget {

  const JobPreferencesTimeZone({Key? key}) : super(key: key);

  @override
  JobPreferencesTimeZoneController createState() => JobPreferencesTimeZoneController();
}
...
class JobPreferencesTimeZoneView extends WidgetView<JobPreferencesTimeZone, JobPreferencesTimeZoneController> {

  const JobPreferencesTimeZoneView(JobPreferencesTimeZoneController state, {super.key}) : super(state);
...
class JobPreferencesTimeZoneController extends State<JobPreferencesTimeZone> {
  ...
  @override
  Widget build(BuildContext context) => JobPreferencesTimeZoneView(this);
