...
class PersonalFeaturedProjectsWidget extends StatelessWidget {
  const PersonalFeaturedProjectsWidget({Key? key}) : super(key: key);
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                      ...
                      child: ShowItemWidget(showModel: show, showActionBar: false,pageName: 'personal_featured_shows',)
                  );
