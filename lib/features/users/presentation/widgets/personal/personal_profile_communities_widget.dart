...
class PersonalProfileCommunitiesWidget extends StatelessWidget {
  const PersonalProfileCommunitiesWidget({Key? key}) : super(key: key);
    ...
    return BlocSelector<UserProfileCubit, UserProfileState,
      ...
      selector: (userState) {
        ...
        final index = userProfiles
            .indexWhere((element) => element.username == currentUser.username);
        if (index < 0) {
          return null;
        }
