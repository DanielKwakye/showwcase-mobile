...
class GrowingCommunitiesCubit extends CommunityCubit {

  GrowingCommunitiesCubit({required super.communityRepository, required super.authBroadcastRepository, required super.communityBroadcastRepository});

  /// Fetch current user's communities  -------

  Future<Either<String, List<CommunityModel>>> fetchGrowingCommunities({required int pageKey}) {
    ...
    final path =   ApiConfig.fetchGrowingCommunities(skip: skip,limit: defaultPageSize);
