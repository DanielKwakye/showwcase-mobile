...
class CommunityMediaThreadsCubit extends ThreadCubit {

  CommunityMediaThreadsCubit(super.threadRepository, {required super.threadBroadcastRepository});

  Future<Either<String, List<ThreadModel>>> fetchMediaThreadFeeds({required int pageKey,required String communityName,required String? tag,String? feedType}) async {
