...
class ActiveCommunitiesCubit extends CommunityCubit {

  ActiveCommunitiesCubit({required super.communityRepository, required super.authBroadcastRepository, required super.communityBroadcastRepository});

  /// Fetch current user's communities  -------

  Future<Either<String, List<CommunityModel>>> fetchActiveCommunities({required int pageKey}) {
    ...
    final path =  ApiConfig.fetchActiveCommunities(limit: defaultPageSize,skip: skip);
