...
class CommunityCodeThreadsCubit extends ThreadCubit {

  CommunityCodeThreadsCubit(super.threadRepository, {required super.threadBroadcastRepository});

  Future<Either<String, List<ThreadModel>>> fetchCommunityCodeThreadFeeds({required int pageKey,required String communityName,required String? tag,String? feedType}) async {
