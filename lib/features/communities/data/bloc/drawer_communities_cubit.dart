...
class DrawerCommunitiesCubit extends CommunityCubit {

  DrawerCommunitiesCubit({required super.communityRepository, required super.authBroadcastRepository, required super.communityBroadcastRepository});

  /// Fetch current user's communities  -------

  Future<Either<String, List<CommunityModel>>> fetchDrawerCommunities({required UserModel userModel, required int pageKey}) {
