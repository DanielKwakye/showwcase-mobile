...
class ProposedCommunitiesCubit extends CommunityCubit {

  ProposedCommunitiesCubit({required super.communityRepository, required super.authBroadcastRepository, required super.communityBroadcastRepository});

  /// Fetch current user's communities  -------

  Future<Either<String, List<CommunityModel>>> fetchProposedCommunities({required int pageKey}) {
    ...
    final path =  ApiConfig.fetchProposedCommunities(skip: skip,limit: defaultPageSize);
