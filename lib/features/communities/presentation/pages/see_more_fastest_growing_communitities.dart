...
class SeeMoreFastestGrowingCommunities extends StatefulWidget {
  const SeeMoreFastestGrowingCommunities({Key? key}) : super(key: key);

  @override
  State<SeeMoreFastestGrowingCommunities> createState() =>
      _SeeMoreFastestGrowingCommunitiesState();
}

class _SeeMoreFastestGrowingCommunitiesState
    extends State<SeeMoreFastestGrowingCommunities> {
  ...
  Future<dartz.Either<String, List<CommunityModel>>> fetchCommunities(
      int pageKey) async {
    return await _communitiesListCubit.fetchGrowingCommunities(
        pageKey: pageKey);
  }
      ...
      body: CustomScrollView(
        slivers: [
          const CustomInnerPageSliverAppBar(
            pageTitle: 'Fastest Growing Communities',
            pinned: true,
          ),
          PagedSliverList.separated(
            ...
            builderDelegate: PagedChildBuilderDelegate<CommunityModel>(
              itemBuilder: (context, item, index) {
                ...
                return BlocSelector<GrowingCommunitiesCubit, CommunityState,
                    CommunityModel>(
                  selector: (state) {
                  ...
                  builder: (context, community) {
                    return Padding(
                      ...
                      child: CommunityItemWidget(
                        ...
                        community: community,
                        pageName: 'see_more_proposed_community',
                        containerName: 'main',
                      ),
                    );
                  },
