...
class GrowingCommunities extends StatefulWidget {
  const GrowingCommunities({Key? key}) : super(key: key);

  @override
  State<GrowingCommunities> createState() => _GrowingCommunitiesState();
}

class _GrowingCommunitiesState extends State<GrowingCommunities>
    with AutomaticKeepAliveClientMixin<GrowingCommunities> {
  late GrowingCommunitiesCubit _communitiesListCubit;

  @override
  void initState() {
    super.initState();
    _communitiesListCubit = context.read<GrowingCommunitiesCubit>();
    _communitiesListCubit.fetchGrowingCommunities(pageKey: 0);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      color:
          theme.brightness == Brightness.dark ? kAppFaintBlack : kAppLightGray,
      ...
      child: Column(
        ...
        children: [
          ...
          BlocBuilder<GrowingCommunitiesCubit, CommunityState>(
            ...
            builder: (context, state) {
                  ...
                  children: [
                    ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return BlocSelector<GrowingCommunitiesCubit,
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        context.push(context.generateRoutePath(
                            subLocation: seeMoreGrowingCommunities));
                      },
                      child: const Padding(
                        padding:
              ...
              // if (state is FetchGrowingCommunitiesError) {}
              return Container();
            },
          )
        ],
