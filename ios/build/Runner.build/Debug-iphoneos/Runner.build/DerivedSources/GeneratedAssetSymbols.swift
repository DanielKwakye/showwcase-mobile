...
extension ImageResource {
    ...
    static let launchBackgroundBeta = ImageResource(name: "LaunchBackgroundBeta", bundle: resourceBundle)

    /// The "LaunchBackgroundProduction" asset catalog image resource.
    static let launchBackgroundProduction = ImageResource(name: "LaunchBackgroundProduction", bundle: resourceBundle)
    ...
    static let launchImageBeta = ImageResource(name: "LaunchImageBeta", bundle: resourceBundle)

    /// The "LaunchImageProduction" asset catalog image resource.
    static let launchImageProduction = ImageResource(name: "LaunchImageProduction", bundle: resourceBundle)

    /// The "betaLaunchImage" asset catalog image resource.
    static let betaLaunch = ImageResource(name: "betaLaunchImage", bundle: resourceBundle)

    /// The "liveLaunchImage" asset catalog image resource.
    static let liveLaunch = ImageResource(name: "liveLaunchImage", bundle: resourceBundle)

    /// The "productionLaunchImage" asset catalog image resource.
    static let productionLaunch = ImageResource(name: "productionLaunchImage", bundle: resourceBundle)
